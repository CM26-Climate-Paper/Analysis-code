###### --------- > calculating seasonal contemporary layers + projections
library(raster)
library(tidyverse)
library(maps)

######### ----------------------------> create contemporary rasters averaged by season (run once) ####
...
######### ----------------------------> projecting species over seasonal contemporary layers
##### ----------------------------> copying over the static bathymetric variables ####
seasonalDir="/Volumes/SDM /Lacie backup October 2016/Lacie share/Climate_paper/GAM_1/project_20y_avs_seasonal/contemporary"
...
##### ----------------------------> Project full and partial models over these surfaces ####
seasonalDir="/Volumes/SDM /Lacie backup October 2016/Lacie share/Climate_paper/GAM_1/project_20y_avs_seasonal/contemporary"
...
proj_dir="/Volumes/SDM /Lacie backup October 2016/Lacie share/Climate_paper/GAM_1/project_20y_avs_seasonal/contemporary"
