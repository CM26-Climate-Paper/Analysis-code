...
png("/Volumes/SeaGate/ClimatePaperCM2.6/20 year averages.png",
    ...
    units     = "in",
    res       = 1200)
a=levelplot(`st.tif`,main="SST, contemporary",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
b=levelplot(`av20_40/st.tif`,main="SST, Y20-40",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
bb=levelplot(`av40_60/st.tif`,main="SST, Y40-60",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
c=levelplot(`av60_80/st.tif`,main="SST, Y60-80",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))

d=levelplot(`bt.tif`,main="BT, contemporary",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
e=levelplot(`av20_40/bt.tif`,main="BT, Y20-40",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
f=levelplot(`av40_60/bt.tif`,main="BT, Y40-60",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
g=levelplot(`av60_80/bt.tif`,main="BT, Y60-80",par.settings=myTheme_temp,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))

h=levelplot(`SS.tif`,main="SS, contemporary",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
i=levelplot(`av20_40/SS.tif`,main="SS, Y20-40",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
j=levelplot(`av40_60/SS.tif`,main="SS, Y40-60",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
k=levelplot(`av60_80/SS.tif`,main="SS, Y60-80",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))

l=levelplot(`bs.tif`,main="BS, contemporary",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
m=levelplot(`av20_40/bs.tif`,main="BS, Y20-40",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
n=levelplot(`av40_60/bs.tif`,main="BS, Y40-60",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
o=levelplot(`av60_80/bs.tif`,main="BS, Y60-80",par.settings=myTheme_salinity,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))

p=levelplot(`sh.tif`,main="SSH, contemporary",par.settings=myTheme_sh,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
q=levelplot(`av20_40/sh.tif`,main="SSH, Y20-40",par.settings=myTheme_sh,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
r=levelplot(`av40_60/sh.tif`,main="SSH, Y40-60",par.settings=myTheme_sh,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
s=levelplot(`av60_80/sh.tif`,main="SSH, Y60-80",par.settings=myTheme_sh,between = list(x=0.1, y=0.1),margin=F,colorkey=T)+ layer(sp.polygons(bPols))
